# Generated by Django 5.0.3 on 2024-04-18 20:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='magazine',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.magazine'),
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('publicacio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.publicacio')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.user')),
            ],
            options={
